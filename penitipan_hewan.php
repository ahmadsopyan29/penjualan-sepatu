...
?>
            ...
            <div class="col-sm-3">
                      ...
                      <p><?php echo $row['deskripsi']; ?></p>
											<a href="penitipan_detail.php?id_paket_penitipan=<?php echo $row['id_paket_penitipan']; ?>" style="margin-bottom:23px" class="btn btn-default add-to-cart"><i class="fa fa-plus-square"></i> Lihat</a>
                      <a href="pesan_penitipan.php?id_paket_penitipan=<?php echo $row['id_paket_penitipan']; ?>" style="margin-bottom:23px" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i> Pesan</a>
