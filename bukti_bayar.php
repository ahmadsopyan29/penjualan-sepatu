...
FROM tb_pembayaran ORDER BY id_pembayaran DESC");
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
  ...
  <body>
		<table>
          ...
          <?php 
          $query1        = "SELECT * FROM tb_pembayaran a JOIN tb_customer b ON a.id_customer = b.id_customer ORDER BY id_pembayaran";
		...
		<p><strong><img src='gambar/<?php echo $data1['foto']; ?>' width='300'/></strong>
