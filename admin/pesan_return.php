              ...
              if (mysqli_num_rows($result) > 0)
              {
                while ($data = mysqli_fetch_array($result))
                {
                  echo "<tr>
                          ...
                          <td style='text-align: left'>".$data['id_return']."</td>
                          
                          
                          <td style='text-align: left'>".$data['tanggal']."</td>
                          <td style='text-align: left'>".$data['username']."</td>
                          <td style='text-align: left'>".$data['status_return']."</td>
                          <td style='text-align: center'>
                            <a href='pesan_return_edit.php?id_return=$data[id_return]'>
                              <button type='submit' class='btn btn-primary'>Ubah</button>
                            </a>
                            <a href='invoice_return.php?id_return=$data[id_return]'>
