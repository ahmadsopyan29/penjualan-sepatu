      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li>Customer</li>
            <li class="active"><a href="#">Ubah Data Customer</a></li>
          </ol>
        </section>
        ...
        ?>
        <form action="data_customer_update.php" method="post" enctype="multipart/form-data">
            <div class="row">
                  ...
                  <div class="box-body">
                    <div class="row">
                      ...
                      <div class="col-xs-4"><label> Username</label>
                        <input class="form-control" name="id_customer" type="hidden" value="<?php echo $data['id_customer'] ?>"/>
