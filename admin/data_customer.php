    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1>Data Customer <small><a href="data_customer_tambah.php">Tambah</a></small></h1>
                ...
                while ($data = mysqli_fetch_array($result))
                {
                  echo "<tr>
                          ...
                          <td style='text-align: center'>
                            <a href='data_customer_edit.php?id_customer=$data[id_customer]'>
                              <button type='submit' class='btn btn-primary'>Ubah</button>
                            </a>
                            <a href='data_customer_hapus.php?id_customer=$data[id_customer]'>
