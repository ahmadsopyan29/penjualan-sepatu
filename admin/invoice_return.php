...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    ...
    <title>Invoice #<?php echo $id_return; ?></title>
    <style type="text/css">
		.tabel2 {
		  width: 100%;
  ...
  <body>
		<table>
		  <tr>
		    <td>
		      <font style="font-size: 25px; text-align: left"><br/><b> Threeman Store</b></font><br/>
		...
		<p>Status return :  <strong><?php echo $data1['status_return']; ?></strong></p>
