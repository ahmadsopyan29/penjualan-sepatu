    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1>Data Stok Barang <small><a href="tambah_stok.php">Tambah</a></small></h1>
        ...
        <div class="box">
          <div class="box-body table-responsive padding">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php
              $sql = "SELECT * FROM tb_stok JOIN tb_barang ON tb_barang.id_barang=tb_stok.id_barang ORDER BY id_stok ASC";
              ...
              if (mysqli_num_rows($result) > 0)
              {
                while ($data = mysqli_fetch_array($result))
                {
                  echo "<tr>
                          ...
                          <td style='text-align: left'>".$data['ukuran']."</td>
