      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li>Customer</li>
            <li class="active"><a href="#">Input Data Customer</a></li>
          </ol>
        </section>

        <section class="content">
        
        <form action="data_customer_simpan.php" method="post" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <h3 class="box-title"> Form Input Data Customer</h3>
              </div>
                  <div class="box-body">
                    <div class="row">
