      ...
      <div class="content-wrapper">
        ...
        <div class="box">
          ...
          {echo "<center><h4>Dari Tanggal = $dari Sampai Tanggal = $sampai <br> Dalam Periode Ini , Belum Ada Transaksi</h4></center>";}
            ...
            <a href='cetak_laporan_penjualan.php?dari=$dari&&sampai=$sampai' target='_BLANK' class='btn btn-success'><i class='fa fa-print'></i> Cetak</a>
            </div>
    ...
    while($data = mysqli_fetch_array($hasil1))
    {
      ...
      <tbody>
        <tr>
          ...
          <td data-title='Harga Diskon' align='center'>$data[status_order]</td>
          <td data-title='Harga Diskon' align='center'>$data[ukuran]</td>
          <td data-title='Harga Diskon' align='center'>$data[jumlah]</td>
          <td data-title='Harga Diskon' align='center'>$data[subtotal]</td>
      ...
      $no++;
            ...
            $query        = "SELECT sum(subtotal) AS grandtotal FROM tb_order a 
                          JOIN detail_order b ON a.id_order = b.id_order
                          JOIN tb_barang c ON b.id_barang = c.id_barang
                          JOIN tb_customer d ON b.id_customer = d.id_customer
        ...
        <tr>
          <td data-title='No.' colspan='8' align='right'><b> TOTAL</b></td>
