					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href=""><i class="fa fa-phone"></i> 021 5989 3897</a></li>
								<li><a href=""><i class="fa fa-envelope"></i> info@threeman-store.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
			...
			<div class="container">
              ...
              <li>
                ...
                <a href='<?php echo $base_url ?>order.php'>
                  <span class='glyphicon glyphicon-book' aria-hidden='true'></span> History
                </a>
              </li>
							<li>
                <a href='<?php echo $base_url ?>return.php'>
                  <span class='glyphicon glyphicon-upload' aria-hidden='true'></span> Return
                </a>
              </li>
              <li>
			...
			<div class="container">
				<div class="row">
                    ...
                    <ul role="menu" class="sub-menu">
                          ...
                          while($data1 = mysqli_fetch_array($sql)){echo "
                          
                        
												<li>
													<div class='panel-heading'>
														<h5 class='panel-title'><a href='barang_kategori.php?id_kategori=$data1[id_kategori]'>$data1[nama_kategori]</a></h5>
													</div>
												</li>";}
												?>
